	...
	$.widget('comiseo.daterangepicker', {
		...
		options: {
			...
			presetRanges: [
						...
						{text: 'This week', dateStart: function() { return moment().subtract('days').isoWeekday(0) }, dateEnd: function() { return moment() } },
						{text: 'Last Week (Sun-Sat)', dateStart: function() { return moment().subtract('days', 7).isoWeekday(0) }, dateEnd: function() { return moment().subtract('days', 7).isoWeekday(6) } },
						{text: 'Last 2 Weeks', dateStart: function() { return moment().subtract('days', 14).isoWeekday(0) }, dateEnd: function() { return moment().subtract('days', 7).isoWeekday(6) } },
						//~ {text: 'Month to Date', dateStart: function() { return moment().startOf('month') }, dateEnd: function() { return moment() } },
						{text: 'Current Month', dateStart: function() { return moment().startOf('month') }, dateEnd: function() { return moment() } },
						...
						{text: 'Current Year', dateStart: function() { return moment().startOf('year') }, dateEnd: function() { return moment() } }
						],
			verticalOffset: 0,
			initialText: 'ALL ( or select date range )', // placeholder text - shown when nothing is selected
			icon: 'ui-icon-triangle-1-s',
            applyButtonText: 'Apply',
            clearButtonText: 'ALL Trades',
